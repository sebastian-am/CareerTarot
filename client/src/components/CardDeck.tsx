...
function FourSidedStar() {
  return (
    <div className="relative w-24 h-24">
      {/* Outer diamond */}
      <div className="absolute inset-0 border-2 border-golden-300 transform rotate-45"></div>
      {/* Inner diamond */}
      <div className="absolute inset-4 border-2 border-golden-300 transform rotate-45"></div>
      {/* Center point */}
